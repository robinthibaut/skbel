...
@inproceedings{michel_improving_2020,
   author = {Hadrien Michel and Frederic Nguyen and Thomas Hermans},
   doi = {10.1002/essoar.10501770.1},
   month = {1},
   publisher = {American Geophysical Union},
   title = {Improving Bayesian Evidential Learning 1D imaging (BEL1D) accuracy through iterative prior resampling},
   url = {http://dx.doi.org/10.1002/essoar.10501770.1},
   year = {2020},
}
@article{Park2020,
...
@article{Scheidt2015a,
   ...
   issue = {2},
   journal = {Mathematical Geosciences},
   keywords = {Groundwater,Inverse problems,Prior models,Relationship data prediction,Subsurface geological modeling,Uncertainty quantification},
   month = {1},
   pages = {173-191},
   title = {Prediction-Focused Subsurface Modeling: Investigating the Need for Accuracy in Flow-Based Inverse Modeling},
   volume = {47},
