...
The first and main author of this package is MSc. Ir. `Robin Thibaut <https://orcid.org/0000-0001-7556-2700>`_ as part of his doctoral research project `A new framework for Experimental Design in Earth Sciences using Bayesian Evidential Learning (BEL4ED) <https://www.researchgate.net/project/A-new-framework-for-Experimental-Design-in-Earth-Sciences-using-Bayesian-Evidential-Learning-BEL4ED>`_ at Ghent University, Department of Geology, `Laboratory for Applied Geology and Hydrogeology (LTGH) <https://www.ugent.be/we/geologie/en/research/organization/applied-geology-and-hydrogeology>`_, supervised by Prof. Dr. Ir. `Thomas Hermans <https://orcid.org/0000-0001-9522-1540>`_ (Ghent University) and Dr. Ir. `Eric Laloy <https://scholar.google.com/citations?user=QrvhkvQAAAAJ&hl=en>`_ (SCK CEN: Belgian Nuclear Research Centre).
