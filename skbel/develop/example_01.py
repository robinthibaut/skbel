#  Author: Maximilian Ramgraber, Massachusetts Institute of Technology
...
from transport_map_116 import TransportMap  # My transport map toolbox
...
tm = TransportMap(
    ...
    polynomial_type="probabilist's hermite",  # Which polynomial function to use for the map component basis functions?
